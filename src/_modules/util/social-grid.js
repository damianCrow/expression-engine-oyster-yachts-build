...
define(['jquery', './social-mock-data'], function($, socialItems) {
	...
	SocialItem.prototype.buildElement = function() {
		...
		if (this.platform === "youtube") {
			...
			// return $('<a target="_blank" href="' + this.data.url + '" class="social-slide social-slide-youtube"><img src="' + this.data.image + '" /><i class="fa fa-youtube-play"></i></a>');
		...
		// instagram
			...
			// return $('<a target="_blank" href="' + this.data.url + '" class="social-slide social-slide-instagram"><img src="' + this.data.image + '" /><i class="fa fa-instagram"></i></a>');
