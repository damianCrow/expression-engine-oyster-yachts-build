...
define(['jquery'], function($) {
  ...
  $('.add-to-shortlist').on('click', function() {
    ...
    console.log('first list', shortlistYachts);

    // Check for dud or undefined items and create an array with them removed.
  ...
  function checkIfYachtShortlist(yachtId, yachtImage, yachtModal, yachtName, yachtSection, yachtSpec) {
    ...
    if (shortlistCheck.length) {
      ...
      var ripYachtDetails = new yachtDetails(yachtId, yachtImage, yachtModal, yachtName, yachtSection, yachtSpec);
  ...
  function yachtDetails(yachtid, image, yachtmodal, name, yachtSection, yachtSpec) {
    this.yachtid = yachtid;
    this.image = image;
    this.yachtmodal = yachtmodal;
    this.name = name;
    this.yachtSection = yachtSection;
    this.yachtSpec = yachtSpec;
  };
  ...
  function displayOnShortlist() {
    ...
    $.each(shortlistYachts, function(key, yachtOnList) {
      ...
      console.log('yachtOnList.image', yachtOnList.image);
  ...
  function enableRemoveFromList() {
    $('.yachts-shortlist').on('click', '.remove-button', function(e) {
      ...
      removeFromList(yachtToRemoveId, yachtToRemove);

    });
  }

  function removeFromList(yachtToRemoveId, yachtToRemove) {
    var refinedList = $.grep(shortlistYachts, function(e) {
  ...
  function toggleEmptyShortlistMessage(shortlistYachts) {
    ...
    var el = document.getElementsByClassName(shortlistCont)[0];

    var requestBtn = document.querySelector('#shortlistModal .request-spec-button');
