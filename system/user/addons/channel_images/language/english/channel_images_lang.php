...
'ci:adv_settings' =>  'Advanced Settings',
...
'ci:limit_stored_images_author'	=>	'Limit Stored Images by Author?',
'ci:limit_stored_images_author_exp'	=>	'When using the Stored Images feature, all images uploaded by everyone will be searched. <br />Select YES to limit the searching to images uploaded by the current member.',
...
// Field Columns
'ci:field_columns'		=>	'Field Columns (table layout only)',
'ci:field_columns_exp'	=>	'Specify a label for each column, leave the "Field Label" blank to disable the column. The second field is for default content, some variables can be used.',
'ci:row_num'		=>	'#',
'ci:id'				=>	'ID',
'ci:image'			=>	'Image',
'ci:title'			=>	'Title',
