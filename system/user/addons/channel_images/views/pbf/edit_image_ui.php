    ...
    <div class="eiw_left">
        ...
        <div class="ci_eiw_bottombar bottombar">
            <span class="crop_holder" style="display:none">
                <a class="btn tn action submit apply_crop"><?=lang('ci:apply_crop')?></a>
                <a class="btn tn action submit cancel_crop"><?=lang('ci:cancel_crop')?></a>
                <br clear="all"><br>
                ...
                <br clear="all"><br>
                <a class="btn tn action submit set_sel"><?=lang('ci:set_crop_sel')?></a>
            </span>
            <span class="save_image_holder">
                ...
                <a class="btn submit save_image"><?=lang('ci:save_img')?></a>
                <a class="btn submit cancel_image"><?=lang('ci:cancel')?></a>
            </span>
