...
//	Codeigniter (2.1.x) is Copyright (c) 2008 - 2011, EllisLab, Inc.
//	and the license for the version derived from can be found
//	here: https://github.com/bcit-ci/CodeIgniter/blob/v2.1.0/license.txt
...
;(function() {
	...
	var xssClean = Security.xssClean = function (str, isImage)
	{
		...
		//this sometimes failes with random % signs in text.
		try {
