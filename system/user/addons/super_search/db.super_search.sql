...
`curated_count`	int(10)			unsigned NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS `exp_super_search_curated_entries` (
	`curated_id`			int(10) unsigned		NOT NULL AUTO_INCREMENT,
