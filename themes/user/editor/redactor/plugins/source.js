(function($)
{
	$.Redactor.prototype.source = function()
	{
		return {
			...
			toggle: function()
			{
				return (this.source.$textarea.hasClass('opened')) ? this.source.hide() : this.source.show();
			},
			hide: function()
			{
				this.source.$textarea.removeClass('opened').hide();
			...
			show: function()
			{
				...
				this.source.$textarea.val(code).height(height).addClass('opened').show();
